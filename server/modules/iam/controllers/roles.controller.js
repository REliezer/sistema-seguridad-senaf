...
export async function updateRolById(req, res, next) {
  try {
    const { id } = req.params;
...
export async function deleteRolById(req, res, next) {
  try {
    const { id } = req.params;
...
// ------------------------------------------------------------------
export async function getPermissionsRolByKey(req, res, next) {
    try {
...
// ------------------------------------------------------------------
export async function replacePermissionsRolByKey(req, res, next) {
    try {
